...
class RecursiveCombatTest {
    ...
    void playInfiniteGame() {
        final RecursiveCombat combat = new RecursiveCombat(List.of(43,19), List.of(2, 29, 14));
        combat.play();
    ...
    @Test
    void play() {
        final RecursiveCombat combat = new RecursiveCombat(List.of(9, 2, 6, 3, 1), List.of(5, 8, 4, 7, 10));
        combat.play();
